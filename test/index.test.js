...
describe('index test', () => {
    it('parses a valid binary command yaml', () => {
        ...
        return validator(yamlString).then(config => {
    ...
    it('validates a poorly structured command yaml', () => {
        ...
        return validator(yamlString).then(result => {
            ...
            const missingField = hoek.reach(result.command, result.errors[0].path[0]);
            ...
            const missingField2 = hoek.reach(result.command, result.errors[1].path[0]);
    ...
    it('throws when parsing incorrectly formatted yaml', () => {
        ...
        return validator(yamlString).then(assert.fail, err => {
